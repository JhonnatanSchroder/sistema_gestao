 <!-- ======= Footer ======= -->
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Sistema Gestão</span></strong>. Todos os Direitos Reservados
    </div>
  ...
  <script src="<?=$base?>/assets/js/jquery.maskMoney.js" type='text/javascript'></script>
